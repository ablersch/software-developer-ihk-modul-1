...
namespace Uebung_Banksystem
{
    class Program
    {
        ...
        private static Dictionary<int, Konto> kontoDic = new Dictionary<int, Konto>();
                ...
                switch (auswahl)
                {
                    ...
                    case "b":
                        ...
                        while (konto == null)
                        {
                            ...
                            konto = konten.Where(x => x.Kontonummer == kontoNr).FirstOrDefault();
        ...
        {
            List<Konto> returnList = new List<Konto>();
            foreach (var konto in kontoDic)
            {
                if (konto.Value.Inhaber.Name == name) returnList.Add(konto.Value);
            }
            return returnList;
        }
